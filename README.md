...
[![Playwright Tests](https://github.com/abhi-qa-lead/corto-qe/actions/workflows/playwright.yml/badge.svg?branch=main)](https://github.com/abhi-qa-lead/corto-qe/actions/workflows/playwright.yml)
[![Live Reports](https://img.shields.io/badge/Live%20Reports-View%20on%20GitHub%20Pages-2ea44f?logo=github)](https://abhi-qa-lead.github.io/corto-qe/)
[![Playwright](https://img.shields.io/badge/built%20with-Playwright-2EAD33?logo=playwright&logoColor=white)](https://playwright.dev/)
[![CodeQL](https://github.com/abhi-qa-lead/corto-qe/actions/workflows/github-code-scanning/codeql/badge.svg?branch=main)](https://github.com/abhi-qa-lead/corto-qe/actions/workflows/github-code-scanning/codeql)
[![Watch the walkthrough](https://img.shields.io/badge/▶%20Watch-Project%20Walkthrough-FF0000?logo=youtube&logoColor=white)](https://youtu.be/YzxepEVlW60)

## 🎥 Project walkthrough

A full end-to-end video walkthrough of this project - covering RBT planning, Jira flow, code architecture, the bugs uncovered, CI/CD, and live reports - is available on YouTube:

[![Project walkthrough](https://img.youtube.com/vi/YzxepEVlW60/maxresdefault.jpg)](https://youtu.be/YzxepEVlW60)
...
> 📊 **Live test reports:** every push to `main` publishes a unified UI + API test dashboard to GitHub Pages - viewable in any browser, no clone or setup required. See [**Public test reports via GitHub Pages**](#public-test-reports-via-github-pages) below.
>
...
**Live (after every push to `main`):** A unified dashboard linking to both UI and API reports is published to GitHub Pages - see the [CI/CD section](#cicd) below for details.

**Local:** the standard Playwright HTML report is generated after every run:
...
.github/
├── workflows/
│   └── playwright.yml               # CI: parallel UI/API jobs + GitHub Pages publish
└── scripts/
    ├── generate-landing-page.sh     # Renders the Pages landing page from the template
    └── landing-page.html.tmpl       # HTML/CSS template with envsubst placeholders
```
...
### Test reports via GitHub Pages

Every push to `main` publishes a unified dashboard to GitHub Pages with a landing page linking into the full Playwright HTML reports (`/ui/` and `/api/`) - viewable in any browser, no clone required. The landing page is generated from a small bash script + HTML template under `.github/scripts/` to keep the workflow YAML clean.
